...
export default function AllCourses() {
  ...
  <CardFooter>
    <ButtonGroup spacing='2'>
      ...
      <Button variant='ghost' colorScheme='blue' onClick={()=>{router.push('/Courses/Metaverse')}} >
      View in Detail...
      </Button>
    </ButtonGroup>
  </CardFooter>
  ...
  <CardFooter>
    <ButtonGroup spacing='2'>
      ...
      <Button variant='ghost' colorScheme='blue' onClick={()=>{router.push('/Courses/Ai')}}>
      View in Detail...
      </Button>
    </ButtonGroup>
  </CardFooter>
  ...
  <CardFooter>
    <ButtonGroup spacing='2'>
      ...
      <Button variant='ghost' colorScheme='blue' onClick={()=>{router.push('/Courses/Cloud')}}>
      View in Detail...
      </Button>
    </ButtonGroup>
  </CardFooter>
  ...
  <CardFooter>
    <ButtonGroup spacing='2'>
      ...
      <Button variant='ghost' colorScheme='blue' onClick={()=>{router.push('/Courses/Ambient')}}>
      View in Detail...
      </Button>
    </ButtonGroup>
  </CardFooter>
...
{/* Card 5 */}
  ...
  <CardFooter>
    <ButtonGroup spacing='2'>
      ...
      <Button variant='ghost' colorScheme='blue' onClick={()=>{router.push('/Courses/Genomics')}}>
      View in Detail...
      </Button>
    </ButtonGroup>
  </CardFooter>
...
{/* Card 6 */}
  ...
  <CardFooter>
    <ButtonGroup spacing='2'>
      ...
      <Button variant='ghost' colorScheme='blue' onClick={()=>{router.push('/Courses/Network')}}>
      View in Detail...
      </Button>
    </ButtonGroup>
  </CardFooter>
